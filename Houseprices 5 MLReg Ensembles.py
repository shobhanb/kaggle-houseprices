...
parameters = [
    {
        ...
        'reg__estimator__max_depth': np.arange(10,50,10)
    },
    {
        'reg__estimator': [AdaBoostRegressor()],
        'reg__estimator__n_estimators': np.arange(50, 500, 50),
        'reg__estimator__learning_rate': np.arange(0.25,1.5,0.25),
    },
    {
        'reg__estimator': [GradientBoostingRegressor()],
        'reg__estimator__learning_rate': [0.01, 0.03, 0.05, 0.07, 0.1],
        'reg__estimator__n_estimators': np.arange(50, 400, 50),
        'reg__estimator__subsample': np.arange(0.50,1,0.10),
    },
    {
        'reg__estimator': [BaggingRegressor()],
        'reg__estimator__n_estimators': np.arange(5, 20, 5),
    },
]
...
cvresults.to_csv('cvresults Ensemble.csv')
...
filename = 'Submission 5 - Tuned Ensemble.csv'
