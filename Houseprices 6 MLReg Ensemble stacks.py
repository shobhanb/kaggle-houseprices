...
parameters = [
    {
        'reg__estimator': [VotingRegressor(estimators=models_for_stacking)],
    },
    {
        'reg__estimator': [StackingRegressor(estimators=models_for_stacking)],
        'reg__estimator__final_estimator': [Ridge(), Lasso(), SVR(), RandomForestRegressor()],
    },
]
...
cvresults.to_csv('cvresults Ensemble Stacking-Voting.csv')
